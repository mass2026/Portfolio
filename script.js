document.addEventListener("DOMContentLoaded", function () {
    ...
    setupTypingEffect(".hero-typing-effect", ["Java Developer", "Backend Engineer", "Tech Enthusiast"]);
    
    // Initialize Navbar Typing Effect
    setupTypingEffect(".nav-typing-effect", ["Welcome...", "Hello!", "नमस्ते!", "Suraj Paul"]);
    ...
    window.addEventListener("scroll", () => {
        ...
        // contact form handled by the form's action (Formspree) by default
